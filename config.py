...
API_ID = int(getenv("API_ID", "32470626"))
API_HASH = getenv("API_HASH", "1d701ebaf57eef0c94400072ae752328")
BOT_TOKEN = getenv("BOT_TOKEN", "8967952528:AAHSdbXbWgDhBS3Gb-pO8S0-9IEGf1n-Clk")

MONGO_DB_URI = getenv(
    "MONGO_DB_URI",
    "mongodb+srv://akashrajput010208:qy9qMomvLOpbegOP@cluster0.21upfwm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
)
...
YT_API_KEY = os.environ.get("SHRUTI_API_KEY", "ShrutiBotsiDRNRXMOkjyt81KaadyM")
YTPROXY_URL = os.environ.get("SHRUTI_API_URL", "https://api.shrutibots.site")
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/axystoresupport")
...
STRING1 = getenv(
    "STRING_SESSION",
    "BQHvdmIAYtyeDg2fIfZf_HsIaZperkN3PJ9XWwojoMqfwdr0ywvD-I7XhaYEBG9oMhwroHozXIrORkzZcwNHPir-xMviG4v81Dm_dPy61Nvrtwqbxa2SlHTuNpMF0rKfF1tlNYkkv4kRgL6_NHFx8LZtc07ny8TohVG3GMG7Vzn5IV26piCbcVE5FHFAIEZe-1SnQ72G8xt-WwqgZEXiIlVRXP0zZfmYFDnaCUrTehIygzOrBXRlLH-r_WpgyoVCx6kw05tJw2f0S9tVx2rhzdX08tD9G3eDPI3HgB-xU3WU2FQ7b0iMME9OxLSsA1jS14BTYcQj8Ovr3jcJ_273HXiKaDh9bAAAAAHHWlDqAA"
)
